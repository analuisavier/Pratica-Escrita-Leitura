...
CAMINHO_DADOS = 'src/dados'
CAMINHO_BACKUP = 'src/backup'
CAMINHO_TEMP = 'src/temp'
...
with open(f'{CAMINHO_DADOS}/diario.txt', 'w', encoding='utf-8') as file:
...
with open(f'{CAMINHO_DADOS}/tarefas.txt', 'w', encoding='utf-8') as file:
    file.write("Lavar a louça\n")
    file.write("Fazer Faxina\n")
    file.write("Preparar a comida\n")
...
with open(f'{CAMINHO_DADOS}/metas.txt', 'w', encoding='utf-8') as file:
    file.write("Viajar de avião\n")
    file.write("Ir em um show de Coldplay\n")
...
with open(f'{CAMINHO_DADOS}/diario.txt', 'r', encoding='utf-8') as file:
    conteudo = file.read()
    print(conteudo)
...
with open(f'{CAMINHO_DADOS}/tarefas.txt', 'r', encoding='utf-8') as file:
    x = 0
    for line in file:
        x += 1
...
with open(f'{CAMINHO_DADOS}/metas.txt', 'r', encoding='utf-8') as file:
    for line in file:
        if line.strip():
            print(f"- {line.strip()}")
...
with open(f'{CAMINHO_DADOS}/diario.txt', 'a', encoding='utf-8') as file:
...
with open(f'{CAMINHO_DADOS}/tarefas.txt', 'a', encoding='utf-8') as file:
    file.write("Arrumar o armário\n")
...
with open(f'{CAMINHO_DADOS}/metas.txt', 'a', encoding='utf-8') as file:
    file.write("Falta pouco tempo para eu conseguir ir em um show de Coldplay\n")
...
with open(f'{CAMINHO_DADOS}/diario.txt', 'r', encoding='utf-8') as origem, \
     open(f'{CAMINHO_BACKUP}/diario_backup.txt', 'w', encoding='utf-8') as destino:
...
with open(f'{CAMINHO_DADOS}/tarefas.txt', 'r', encoding='utf-8') as origem, \
     open(f'{CAMINHO_BACKUP}/tarefas_backup_{data_atual}.txt', 'w', encoding='utf-8') as destino:
    destino.write(origem.read())
...
with open(f'{CAMINHO_DADOS}/metas.txt', 'r', encoding='utf-8') as origem, \
     open(f'{CAMINHO_TEMP}/metas_prioridade.txt', 'w', encoding='utf-8') as destino:
    for linha in origem:
...
with open(f'{CAMINHO_DADOS}/contatos.csv', 'w', newline='', encoding='utf-8') as file:
...
with open(f'{CAMINHO_DADOS}/produtos.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
...
with open(f'{CAMINHO_DADOS}/eventos.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
...
with open(f'{CAMINHO_DADOS}/contatos.csv', newline='', encoding='utf-8') as file:
...
with open(f'{CAMINHO_DADOS}/produtos.csv', newline='', encoding='utf-8') as file:
    reader = csv.reader(file)
    next(reader)  
...
with open(f'{CAMINHO_DADOS}/eventos.csv', newline='', encoding='utf-8') as file:
...
with open(f'{CAMINHO_DADOS}/contatos.csv', 'a', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
...
with open(f'{CAMINHO_DADOS}/produtos.csv', 'a', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
...
with open(f'{CAMINHO_DADOS}/eventos.csv', 'a', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
...
with open(f'{CAMINHO_DADOS}/eventos.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=['artista', 'local', 'data', 'ingressos'])
    writer.writeheader()
    writer.writerows(eventos)
...
# Exercício 2.14
# Verifique se todos os IDs de produtos são únicos
print("\n" + "=" * 60)
...
# Salve os dados de um personagem de RPG em 'personagem.json': nome, nível, pontos de vida, habilidades, equipamentos
print("\n" + "=" * 60)
...
with open(f'{CAMINHO_DADOS}/personagem.json', 'w') as file:
    json.dump(personagem, file, indent=4)
print(" Personagem criado e salvo!")

# Exercício 3.2
# Crie um arquivo 'perfil_instagram.json' com dados de um influenciador: username, seguidores, seguindo, posts, biografia
print("\n" + "=" * 60)
...
with open(f'{CAMINHO_DADOS}/perfil_instagram.json', 'w') as file:
    json.dump(perfil_instagram, file, indent=4)
print(" Perfil Instagram criado!")

# Exercício 3.3
# Armazene os dados de um monstro em 'monstro.json': nome, tipo, nível, pontos de ataque e recompensas
print("\n" + "=" * 60)
...
with open(f'{CAMINHO_DADOS}/monstro.json', 'w') as file:
...
with open(f'{CAMINHO_DADOS}/personagem.json') as file:
...
with open(f'{CAMINHO_DADOS}/perfil_instagram.json') as file:
    dados = json.load(file)
...
with open(f'{CAMINHO_DADOS}/monstro.json') as file:
    dados = json.load(file)
...
with open(f'{CAMINHO_DADOS}/monstro.json') as file:
    ...
    print(f"Valor total das recompensas: {valor_total}")
...
with open(f'{CAMINHO_TEMP}/personagem_min.json', 'w') as file:
...
with open(f'{CAMINHO_BACKUP}/perfil_instagram_backup_{data_atual}.json', 'w') as file:
    json.dump(dados, file, indent=4)
...
with open(f'{CAMINHO_DADOS}/personagem2.json', 'w') as file:
    json.dump(personagem2, file, indent=4)

with open(f'{CAMINHO_DADOS}/personagem.json') as file:
    personagem = json.load(file)

with open(f'{CAMINHO_DADOS}/personagem2.json') as file:
...
with open(f'{CAMINHO_DADOS}/grupo.json', 'w') as file:
...
json_para_csv(f'{CAMINHO_DADOS}/personagem.json', f'{CAMINHO_TEMP}/personagem.csv')
...
with open(f'{CAMINHO_DADOS}/inventario.json', 'w') as file:
    json.dump(inventario, file, indent=4)

with open(f'{CAMINHO_DADOS}/inventario.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    writer.writerow(inventario['itens'][0].keys())
    for item in inventario['itens']:
        writer.writerow(item.values())

with open(f'{CAMINHO_DADOS}/inventario.txt', 'w', encoding='utf-8') as file:
    for item in inventario['itens']:
...
with open(f'{CAMINHO_DADOS}/feed_noticias.json', 'w') as file:
    json.dump(feed_noticias, file, indent=4)

with open(f'{CAMINHO_DADOS}/feed_noticias.txt', 'w', encoding='utf-8') as file:
...
with open(f'{CAMINHO_TEMP}/relatorio_perfil.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
...
salvar_jogo_em_zip(f'{CAMINHO_DADOS}/personagem.json', f'{CAMINHO_TEMP}/save_game.zip')
